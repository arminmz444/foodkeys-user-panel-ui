...
export const routes = {
  ...
  info: {
    ...
    serviceIndustryList: '/info/service-industry',
    serviceIndustryAdd: '/info/service-industry/create',
    serviceIndustryView: (id: number) => `/info/service-industry/${id}`,
    serviceIndustryEdit: (id: number) => `/info/service-industry/${id}/edit`,
    serviceIndustrySubCategoryList: (id: number) => `/info/service-industry/subcategory/${id}`,
    media: '/info/media',
    machineryIndustry: '/info/machinery-industry',
    // dashboard: '/company',
    profile: '/info/profile',
    profileEdit: '/info/profile/edit',
    profilePassword: '/info/profile/password',
    profileNotification: '/info/profile/notification',
    ...
    exhibitionsCreate: '/info/exhibitions/create',
    conferencesCreate: '/info/conferences/create',
    employmentCreate: '/info/employment/create',
    jobsCreate: '/info/jobs/create',
    requestCreate: '/info/request/create',
    resellerCreate: '/info/reseller/create',
    labsCreate: '/info/labs/create',
    certificationsCreate: '/info/certification/create',
    saleFactoryCreate: '/info/sale_factory/create',
    surplusCreate: '/info/surplus/create',
    associationsCreate: '/info/associations/create',
  },
  finance: {
    dashboard: '/finance',
