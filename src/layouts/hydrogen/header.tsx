...
function HeaderMenuRight() {
    ...
    return (
        <div
            className="ms-auto grid shrink-0 grid-cols-4 items-center gap-2 text-gray-700 print:hidden xs:gap-3 xl:gap-4">
            {/*<MessagesDropdown>*/}
            {/*  <ActionIcon*/}
            {/*    aria-label="Messages"*/}
            {/*    variant="text"*/}
        ...
        <>
            <Modal size="lg" isOpen={isOpen} onClose={() => setIsOpen(false)}>
                <div className="m-auto px-7 pt-6 dark:bg-gray-100 dark:text-white">
                    ...
                    <div
                        className="from-blue-500 to-indigo-700 flex min-h-screen flex-col items-center justify-center bg-gradient-to-br p-4 text-black dark:bg-gray-100">
                        <div
