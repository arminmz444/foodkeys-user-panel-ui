...
import InvoiceTable from '@/app/shared/finance/transaction/transaction-list/table';
import { PiPlusBold } from 'react-icons/pi';
import { exportToCSV } from '@/utils/export-to-csv';
import ExportButton from '@/app/shared/export-button';
import TransactionTable from '@/app/shared/finance/transaction/transaction-list/table';
...
export default function TransactionListPage() {
  ...
  useEffect(() => {
    const fetchTransactionData = async () => {
      try {
        const response = await _axios.get(`/transaction/`, {
          params: {
            page: currentPage,
            size: pageSize,
          },
