...
const fetchPayments = async (searchTerm: string, currentPage: number, pageSize: number) => {
    const API_URL = `http://localhost:8080/api/v1/client/panel/payment?pageNumber=${currentPage}&pageSize=${pageSize}&filter=${searchTerm}`
