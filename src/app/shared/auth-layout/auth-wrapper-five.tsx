...
export default function AuthWrapperFive({
  ...
  return (
    <>
      <div className=" relative flex min-h-screen flex-col items-center justify-center p-4 lg:p-5 2xl:p-10">
        <Link
          href={'/'}
          className="block self-start border-gray-300 bg-blue p-4 py-2 text-sm font-medium text-white lg:start-1/2 lg:-translate-x-1/2 lg:justify-start lg:bg-transparent lg:text-gray-700 xl:py-6"
        >
          <div
            className={cn(
          ...
          >
            <PiArrowRightBold />
            <span className="ms-1 font-medium">برگشت به خانه</span>
          </div>
        </Link>
        <div>
          <div
