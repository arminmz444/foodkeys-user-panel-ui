...
export default function IntegrationSettingsView() {
  ...
  return (
    <>
      ...
      <HorizontalFormBlockWrapper title="برنامه ریزی حساب" description=" ">
        <Input
    ...
    >
      ...
      <div className="flex flex-col justify-between p-5 pb-6 sm:p-6">
        <h5 className="mb-2 text-lg font-semibold text-gray-900">
          ما به تازگی یک به‌روزرسانی جدید منتشر کرده‌ایم!
        </h5>
        <p className="mb-5 text-sm font-normal text-gray-500">
          نمایشگر داشبورد تازه را بررسی کنید. صفحات اکنون سریع‌تر بارگذاری
          می‌شوند.
        </p>
