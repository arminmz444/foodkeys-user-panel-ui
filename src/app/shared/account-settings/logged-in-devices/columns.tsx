...
export const getColumns = ({
  ...
  },
  {
    title: (
      <HeaderCell
        title={<span className="whitespace-nowrap">آدرس ایمیل</span>}
      />
    ),
    dataIndex: 'email',
    key: 'email',
  ...
  {
    title: (
      <HeaderCell title={<span className="whitespace-nowrap">تیم ها</span>} />
    ),
    dataIndex: 'teams',
    key: 'teams',
    width: 200,
  ...
  },
  {
    title: (
      <HeaderCell
        className="ps-3"
        title={<span className="whitespace-nowrap">عملیات</span>}
      />
    ),
    dataIndex: 'action',
    key: 'action',
    ...
    render: (_: string, row: any) => (
      <div className="flex items-center justify-end gap-3 pe-4">
        ...
        <DeletePopover
          title={`حذف عضو`}
          description={`آیا میخواهید این عضو را حذف کنید?`}
