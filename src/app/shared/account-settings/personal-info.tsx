            ...
            <Form<PersonalInfoFormTypes>
                ...
                useFormProps={{
                    defaultValues: {
                        ...
                        cityId: user?.cityId || '',
                        individualType: user?.individualType || 0,
                        jobPosition: '',
                        // description: '',
                        pelak: '',
                ...
                {({register, control, formState: {errors}}) => {
                    return (
                        <>
                            ...
                            <div className="w-full max-w-screen-2xl">
                                ...
                                >
                                    <div className="col-span-2 flex flex-col items-center gap-4 @xl:flex-row">
                                        ...
                                        <Button tag="button" variant="outline">
                                            تغییر
                                        ...
                                        render={({field: {value, onChange}}) => (
                                            <SelectBox
                                                ...
                                                displayValue={(selected) =>
                                                    individualType?.find((r) => r.value === selected)?.name ?? ''
                                                }
                                        ...
                                        {images.length ? (
                                            ...
                                            >
                                                {images?.map((file: File, index: number) => (
                                                    ...
                                                    >
                                                        <div
                                                            className="absolute left-0 top-0 z-50 h-full w-full bg-black bg-opacity-40 opacity-0 backdrop-blur-md  transition-all group-hover:opacity-100 dark:bg-opacity-20"></div>
                                                        <Image
                            ...
                            <div
                                className="border-gary-300 sticky bottom-0 z-40 -mx-6 -mb-7 flex items-center justify-end gap-3 border-t bg-gray-0/10 px-10 py-5 backdrop-blur @lg:gap-4 @xl:grid @xl:auto-cols-max @xl:grid-flow-col 3xl:-mx-8 4xl:-mx-10">
