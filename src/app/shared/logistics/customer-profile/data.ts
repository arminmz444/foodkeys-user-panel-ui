...
export const stats = [
  ...
  { icon: InvoicePrint, label: 'سررسید', value: 2890, isCurrency: true },
  { icon: RefundIcon, label: 'برگشت', value: 310, isCurrency: true },
  { icon: ShipWithContainer, label: 'ارسال', value: 120 },
  { icon: CargoDamaged, label: 'آسیب دیده', value: 8 },
  { icon: TurtleIcon, label: 'تحویل خارج از وقت', value: 34 },
  { icon: MagnifyingGlassIconColor, label: 'ارسالی های از دست رفته', value: 2 },
];
