...
// main company form component for create and update
...
export const shipmentFormSchema = z.object({
  country: z
    .string({
      required_error: 'کشور اجباری میباشد',
    })
    .min(1, { message: 'شما باید یک کشور را انتخاب کنید' }),
  ...
  senderEmail: z
    .string()
    .email({
      message: 'آدرس ایمیل اشتباه میباشد',
    })
    .optional(),
