...
const dictStatus: any = {
  Approved: 'تایید شده',
  'Out For Delivery': 'ارسال شده',
  'Delivery Failed': 'ارسال نا موفق',
...
export const getColumns = ({
  ...
  {
    title: <HeaderCell title="شماره پیگیری" />,
    dataIndex: 'trackingNumber',
    key: 'trackingNumber',
    width: 250,
  },
  {
    title: <HeaderCell title="گیرنده" />,
    dataIndex: 'recipient',
    key: 'recipient',
    width: 450,
  ...
  },
  {
    title: (
      <HeaderCell
        title="هزینه کل"
        sortable
        className="me-6 ml-32 justify-end"
        ascending={
  ...
  {
    title: <HeaderCell title="وضعیت فاکتور" />,
  ...
  },
  {
    ...
    render: (_: string, row: any) => (
      <div className="flex items-center justify-center gap-3">
        ...
        <DeletePopover
          title={`حذف سفارش`}
          description={`آیا اطمینان دارید که می‌خواهید این مرسوله با شماره #{row.id} را حذف کنید؟`}
