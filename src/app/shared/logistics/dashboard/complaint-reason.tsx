...
const data = [
  { name: 'بسته آسیب دیده', value: 100, color: '#3872FA' },
  { name: 'قطعات گم شده', value: 80, color: '#7928ca' },
  { name: 'ارسال دیر موقع', value: 50, color: '#eab308' },
  { name: 'از دست رفتن سفارش', value: 30, color: '#f1416c' },
  { name: 'بقیه موارد', value: 20, color: '#c084fc' },
];
