...
export default function AvgDeliveryTime({ className }: { className?: string }) {
  return (
    <WidgetCard
      rounded="lg"
      className={className}
      title="میانگین زمان ارسال"
      description={
        <>
          <Badge renderAsDot className="me-0.5 bg-[#10b981]" /> ارسال به موقع
          <Badge renderAsDot className="me-0.5 ms-4 bg-[#FA436B]" /> ارسال با
          تاخیر
        </>
      }
