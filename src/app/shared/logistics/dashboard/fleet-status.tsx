...
const data = [
  { name: 'موجود:', value: 20, color: '#3872FA' },
  { name: 'در دوره تعمیرات:', value: 18, color: '#eab308' },
  { name: 'در حرکت:', value: 35, color: '#10b981' },
];
    ...
    <div className={cn('flex flex-col gap-5 border-0 p-0 lg:p-0', className)}>
      ...
      <div className="grid gap-5 rounded-lg border border-gray-300 p-4 @2xl:grid-cols-2 @2xl:p-6">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <p className="text-base font-semibold text-gray-900">25 دقیقه</p>
            <p>میانگین زمان بارگیری</p>
          </div>
        </div>
        <div className="flex items-center gap-2.5">
          <div className="flex h-12 w-12 items-center justify-center">
          ...
          <div>
            <p className="text-base font-semibold text-gray-900">13 تن</p>
            <p>میانگین وزن بارگیری</p>
          </div>
        </div>
      </div>
    </div>
