            ...
            >
              <div className="pe-6">
                ...
                <Text className="hidden leading-[1.85] @2xl:block">
                  قبل از ثبت سفارش با مبلغ پرداخت بزرگ، ما توصیه می‌کنیم که با
                  بانک/موسسه صادر کننده کارت تماس بگیرید تا از اینکه بانک پرداخت
                  شما را مسدود کند یا وجوه را نگه دارد، جلوگیری کنید.
                </Text>
              </div>
          ...
          <div className="border-t border-gray-200 p-4 @xs:p-6">
            <div className="space-y-4 ">
              ...
              <Checkbox
                ...
                label="ذخیره برای خرید های آینده"
                variant="flat"
