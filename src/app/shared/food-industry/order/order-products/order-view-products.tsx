...
const data = [
  ...
  },
  {
    ...
    title: 'لوکس مارک جیکوب',
    productPrice: 'تومان80.00',
    price: 'تومان160.00',
    quantity: 2,
  },
  {
...
const columns = [
  ...
  {
    title: <HeaderCell title="قیمت محصول" />,
    dataIndex: 'productPrice',
    key: 'productPrice',
    width: 200,
  },
  {
    title: <HeaderCell title="مقدار" align="center" />,
    dataIndex: 'quantity',
    key: 'quantity',
    width: 150,
  ...
  {
    title: <HeaderCell title="قمیت" align="right" />,
    dataIndex: 'price',
    key: 'price',
    width: 200,
    render: (price: string) => (
