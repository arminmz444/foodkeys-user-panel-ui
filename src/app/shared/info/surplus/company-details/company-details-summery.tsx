...
const colors = [
  { name: 'سبز لجنی', code: '#6AA39C' },
  { name: 'آبی', code: '#6BDCFF' },
  { name: 'بنفش', code: '#5D30DD' },
  { name: 'قرمز', code: '#D72222' },
  { name: 'صورتی', code: '#C886A9' },
];
...
function AddToCartButton() {
  function handleAddToCart() {
    toast.success(<Text tag="b">محصول به سبد خرید اضافه شد</Text>);
  }
  return (
    <Button
      size="xl"
...
export default function CompanyDetailsSummery() {
  return (
    <>
      ...
      <div className="pb-8 pt-5">
        <div className="font-iransans mb-1.5 mt-2 flex items-end text-base">
          <div className="-mb-0.5 text-2xl font-semibold text-gray-900 lg:text-3xl">
            12500000 تومان
          </div>
          <del className="ps-1.5 font-medium text-gray-500">13000000 تومان</del>
          <div className="ps-1.5 text-red">(25% تخفیف)</div>
        </div>
        <div className="font-medium text-green-dark">معاف از مالیات</div>
        ...
        <Text
          tag="h6"
          className="font-iransans mb-3.5 mt-6 font-inter text-sm font-medium"
        >
          انتخاب رنگ
        </Text>
