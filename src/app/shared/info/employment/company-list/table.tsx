...
const fetchCompanies = async (
  ...
  const API_URL = searchTerm
    ? `http://192.168.43.57:8080/api/v1/search/company?query=${searchTerm}&page=${currentPage}&size=${pageSize}`
    : `http://192.168.43.57:8080/api/v1/company/?pageNumber=${currentPage}&pageSize=${pageSize}&categoryId=1`;
