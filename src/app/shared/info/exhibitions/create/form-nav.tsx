...
export const menuItems = [
  {
    label: 'معرفی نمایشگاه',
    value: formParts.intro,
  },
  {
    label: 'اطلاعات تماس',
    value: formParts.contact,
  },
  {
    label: 'توضیحات',
  ...
  {
    label: 'لوگوی نمایشگاه',
    value: formParts.logo,
  },
];
...
export default function FormNav({ className }: FormNavProps) {
  return (
    <div
      className={cn(
        'sticky top-[68px] z-20 border-b border-gray-300 bg-gray-0 py-0 font-medium text-gray-500 @2xl:top-[72px] dark:bg-gray-50 2xl:top-20',
        className
      )}
    >
      <SimpleBar>
