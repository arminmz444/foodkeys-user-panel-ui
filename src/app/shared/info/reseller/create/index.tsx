...
import ResellerInfo from './reseller-info';
import ResellerDescription from './reseller-description';
import ResellerContact from './reseller-contact';

const MAP_STEP_TO_COMPONENT = {
  [formParts.intro]: ResellerInfo,
  [formParts.description]: ResellerDescription,
  [formParts.contact]: ResellerContact,
  [formParts.logo]: ResellerDescription,
};
