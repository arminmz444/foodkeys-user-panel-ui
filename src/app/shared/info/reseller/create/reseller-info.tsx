...
export default function ResellerInfo({ className }: { className?: string }) {
  ...
  return (
    <>
      <FormGroup
        title="اطلاعات اعطاکننده"
        description="شامل نام، محصولات تولیدی و ..."
        className={cn(className)}
      >
        <Input
          label="نام شرکت یا کارخانه*"
        ...
        />
        <Input
          label="موقعیت مکانی شرکت یا کارخانه*"
          placeholder="موقعیت مکانی شرکت یا کارخانه"
          {...register('address')}
        ...
        <Textarea
          ...
          placeholder="محصولات تولیدی خود را بنویسید ..."
          {...register('foodType')}
        ...
        <Textarea
          label="برند محصولات"
          placeholder="برند محصولات خود را بنویسید ..."
        ...
        />
        <Textarea
          label="استان ها و شهر های مورد نظر*"
          placeholder="برند محصولات خود را بنویسید ..."
          {...register('broadcastingEquipment')}
          error={errors.broadcastingEquipment?.message as string}
          rows={2}
