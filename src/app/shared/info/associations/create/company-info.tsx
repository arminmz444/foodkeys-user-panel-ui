...
export default function CompanyInfo({ className }: { className?: string }) {
  ...
  return (
    <>
      <FormGroup
        title="اطلاعات انجمن"
        description="شامل نام، آدرس و ..."
        className={cn(className)}
      >
        <Input
          label="نام انجمن یا تشکل*"
          placeholder="نام انجمن یا تشکل"
          {...register('associationName')}
          error={errors.associationName?.message as string}
          required
          className="col-span-full"
          autoFocus
        />
        <Input
          label="نام رئیس هیئت مدیره*"
          placeholder="نام رئیس هیئت مدیره"
          {...register('ceo')}
          error={errors.ceo?.message as string}
          required
        />
        <Input
          label="نام دبیر انجمن*"
          placeholder="نام دبیر انجمن"
          {...register('secretary')}
          error={errors.secretary?.message as string}
          required
        />
        <Input
          label="اعضا هیئت مدیره"
          placeholder="اعضا هیئت مدیره"
          {...register('members')}
          error={errors.members?.message as string}
          className="col-span-full"
        />
        <Textarea
          label="آدرس*"
