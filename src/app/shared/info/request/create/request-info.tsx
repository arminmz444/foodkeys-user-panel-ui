...
export default function RequestInfo({ className }: { className?: string }) {
  ...
  return (
    <>
      ...
      >
        ...
        />
        <Input
          label="شهر یا شهرهای حوضه فعالیت*"
          placeholder="شهر یا شهرهای حوضه فعالیت"
          {...register('city')}
        ...
        />
        <Textarea
          label="نوع مواد غذایی مورد نظر*"
          placeholder="نوع مواد غذایی مورد نظر خود را بنویسید ..."
          {...register('foodType')}
        ...
        />
        <Textarea
          label="امکانات و تجهیزات شما برای پخش*"
          placeholder="امکانات و تجهیزات خود برای پخش خود را بنویسید ..."
          {...register('broadcastingEquipment')}
          error={errors.broadcastingEquipment?.message as string}
          rows={4}
          required
        />
        ...
        />
        <Input
          label="آدرس پستی محل نمایندگی*"
          placeholder="آدرس پستی محل نمایندگی"
          {...register('address')}
