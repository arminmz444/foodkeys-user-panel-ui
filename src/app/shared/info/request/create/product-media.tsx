...
export default function ProductMedia({ className }: ProductMediaProps) {
  ...
  return (
    <FormGroup
      title="آپلود عکس جدید محصول"
      description="عکس محصول خود را اینجا آپلود کنید"
      className={cn(className)}
    >
      <MultipleFiles className="col-span-2" label="عکس ها" />
    </FormGroup>
  );
}
  ...
  return (
    <div className={className}>
      ...
      <p className="pt-3 text-sm text-gray-500">
        عکس محضول خود را اینجا آپلود کنید حجم عکس باید بیشتر از{' '}
