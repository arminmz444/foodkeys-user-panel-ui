...
export const getColumns = ({
  ...
  {
    title: <HeaderCell title="شناسه سفارش" />,
    dataIndex: 'id',
    key: 'id',
    width: 90,
  ...
  },
  {
    ...
    render: (_: string, row: any) => (
      <div className="flex items-center justify-end gap-3 pe-4">
        ...
        <DeletePopover
          title={`حذف سفارش`}
          description={`آیا مطمعنید که میخواهید این سفارش را حذف کنید؟`}
