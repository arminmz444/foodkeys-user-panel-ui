...
import { PiEyeDuotone, PiHand, PiRankingDuotone } from 'react-icons/pi';
...
export const getColumns = ({
  ...
  },
  {
    ...
    width: 5,
    render: (_: string, row: any) => (
      <Text>{(row.rankingAll || 0) + ' / ' + (row.ranking || 0)}</Text>
    ),
  },
  {
    title: <></>,
      ...
      <div className="flex h-full w-full flex-shrink-0 flex-grow-0 items-center justify-end gap-3 pe-3">
        ...
        >
          ...
          <Button
            ...
            className="h-full"
          >
            <PiRankingDuotone className="h-4 w-4 shrink-0 grow-0" />
          </Button>
          {/*<RankRevisionPopover*/}
        ...
        >
          ...
          >
            <Button
              ...
              size="sm"
              variant="outline"
              className="gap-1 bg-white text-black hover:!bg-black hover:text-white"
            >
