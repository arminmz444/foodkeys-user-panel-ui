...
const data: DataType[] = [
  { name: 'ناراضی', percentage: 25, color: '#f1416c' },
  { name: 'طبیعی', percentage: 25, color: '#7928ca' },
  { name: 'راضی', percentage: 25, color: '#3872FA' },
  { name: 'خیلی راضی', percentage: 25, color: '#10b981' },
];
const percentage = 68;
...
export default function SatisfactionRate({
  ...
  return (
    <WidgetCard title="نرخ رضایت مشتری" className={className}>
