...
const FormSchema = z.object({
  message: z.string({ required_error: 'آدرس ایمیل اشتباه میباشد' }),
});
...
const agents = [
  {
    ...
    label: (
      <div className="flex items-center gap-2">
        ...
        />
        <span className="whitespace-nowrap text-xs sm:text-sm">محمد صادق</span>
      </div>
    ),
  },
  {
    ...
    label: (
      <div className="flex items-center gap-2">
        <Avatar
          ...
          className="!h-6 !w-6 rounded-full"
        />
        <span className="whitespace-nowrap text-xs sm:text-sm">نرگس</span>
      </div>
    ),
  },
  {
    ...
    label: (
      <div className="flex items-center gap-2">
        <Avatar
          ...
          className="!h-6 !w-6 rounded-full"
        />
        <span className="whitespace-nowrap text-xs sm:text-sm">صادق</span>
      </div>
    ),
  },
];
