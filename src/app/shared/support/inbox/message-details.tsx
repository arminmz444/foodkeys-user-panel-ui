        ...
        label: (
            <div className="flex items-center gap-2">
                <Avatar
                    ...
                    className="!h-6 !w-6 rounded-full"
                />
                <span className="whitespace-nowrap text-xs sm:text-sm">پشتیبانی فنی</span>
            </div>
        ),
    },
    {
...
export default function MessageDetails({className}: { className?: string }) {
    ...
    return (
        ...
        >
            <div>
                <header
                    className="flex flex-col justify-between gap-4 border-b border-gray-200 pb-5 3xl:flex-row 3xl:items-center">
                    <div
                        className="flex flex-col items-start justify-between gap-3 xs:flex-row xs:items-center xs:gap-6 lg:justify-normal">
