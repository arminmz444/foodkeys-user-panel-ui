    ...
    <>
      <div className="flex justify-between">
        <div className="flex gap-4">
          <Avatar
            name="Andrei Jackson"
            className="bg-[#F1A74F] text-white"
            initials="AJ"
        ...
        <Button color="primary" className="font-500 ms-auto text-white">
          ...
          <span className="ms-1.5 inline-block">دنبال کردن</span>
        </Button>
      </div>
      ...
      <div className="flex items-center justify-between gap-5 border-b border-b-gray-100 pb-6 dark:border-b-gray-400">
        <div className="flex items-center gap-5">
          ...
          >
            ...
            <span className="ms-1.5 inline-block">پسندیدن</span>
          </Button>
          <Button
            variant="text"
            className="font-500 group ms-auto h-auto p-0 text-gray-700"
          >
            ...
            <span className="ms-1.5 inline-block">نظر</span>
          </Button>
        </div>
        <Button
          variant="text"
        ...
        >
          ...
          <span className="ms-1.5 inline-block">اشتراک گذاری</span>
        </Button>
      </div>
    </>
  );
...
function ModalCardComment({ commentData }: CommentPropsType) {
  ...
  return (
    <div className="flex items-start gap-4 pr-3 pt-6">
      <Avatar
        name="Marie Fanned"
        className="bg-[#F1A74F] font-medium text-white"
      ...
      <div>
        ...
        <div className="mt-3 flex gap-6">
          ...
          <Text className="text-xs font-normal">7 ساعت</Text>
        </div>
      </div>
    </div>
  );
...
function LikeCounter() {
  ...
  return (
    ...
    >
      <span className="me-1.5">{count ? 2 : 1}</span> پسندیدن
    </Button>
  );
}
