...
export const getColumns = ({ sortConfig, onHeaderCellClick }: Columns) => [
  {
    title: <HeaderCell title="کانال" className="ps-2 lg:ps-4" />,
    dataIndex: 'channel',
    key: 'channel',
    width: 100,
    hidden: 'channel',
  ...
  {
    title: <HeaderCell title="جلسات فعال" align="right" />,
    dataIndex: 'sessions',
    key: 'sessions',
    width: 150,
    render: (value: number) => (
  ...
  {
    title: <HeaderCell title="نرخ مشارکت" align="right" />,
    ...
    render: (value: Date) => (
      <div className="text-right rtl:text-left">
        <Text className="mb-1 font-medium text-gray-700">
          {dayjs(value).format('m')}دقیقه {dayjs(value).format('ss')}ثانیه
        </Text>
  ...
  {
    title: <HeaderCell title="نرخ جایزه" align="right" />,
