...
export const getColumns = ({
  ...
  {
    title: <HeaderCell title="نام" className="ps-2" />,
    dataIndex: 'file',
    key: 'file',
    width: 220,
    render: (file: any, row: any) => (
      <div className="flex items-center ps-2">
        ...
        <div className="ml-3 rtl:ml-0 rtl:mr-3">
          <Text className="font-iransans mb-0.5 !text-sm font-medium text-gray-900 dark:text-gray-700">
            {file.name}
          </Text>
        </div>
      </div>
  ...
  {
    title: <HeaderCell title="اشتراک‌گذاری" />,
    dataIndex: 'shared',
    key: 'shared',
    width: 150,
    render: (value: any) => {
    ...
    <Popover
      ...
      content={() => (
        <div className="text-gray-900">
          ...
          >
            <PiCopySimple className="ml-2 h-5 w-5 text-gray-500" />
            کپی
          </Button>
          <Button
            variant="text"
            className="flex w-full items-center justify-start px-2 py-2.5 hover:bg-gray-100 focus:outline-none dark:hover:bg-gray-50"
          >
            <PiShareFat className="ml-2 h-5 w-5 text-gray-500" />
            اشتراک گذاری
          </Button>
          <Button
            variant="text"
            ...
            onClick={onDelete}
          >
            <PiTrashSimple className="ml-2 h-5 w-5 text-gray-500" />
            حذف
          </Button>
        </div>
      )}
