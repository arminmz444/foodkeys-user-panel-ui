  ...
  return (
    <>
      <div className="col-span-full flex flex-col justify-center @5xl:col-span-5">
        <FormSummary
          title="مکان ملک شما کجا قرار دارد؟"
          description="اشتراک دانسته‌های خود درباره موقعیت جغرافیایی کمک می‌کند تا ما برنامه‌ها، توصیه‌ها و امکاناتی را تدارک دیده و تنظیم کنیم که با جوان و ماهیت منطقه همخوانی دارد."
        />
      </div>
