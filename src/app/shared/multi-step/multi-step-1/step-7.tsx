...
export const formSchema = z.object({
  propertyName: z.string().min(1, 'نوع عنوان مورد نیاز است.'),
  ...
  return (
    <>
      <div className="col-span-full flex flex-col justify-center @5xl:col-span-5">
        <FormSummary
          title="آشکار کردن جوهر: کشف جزئیات جذاب ملک"
          description="ملک شما بیش از دیوارها و فضاهاست، یک پانوایر از خاطراتی که در انتظار نقاشی است. به اشتراک گذاشتن جزئیات دقیق به ما کمک می‌کند تا یک آگهی جذاب را به وجود آوریم."
        />
      </div>
        ...
        >
          <>
            <Input
              ...
              placeholder="یک عنوان مناسب برای ملک خود اضافه کنید..."
            ...
            <div className="grid gap-4">
              <Text className="font-semibold text-gray-900">رنج قیمت</Text>
              <Controller
                control={control}
                name="priceRange"
                    ...
                    <>
                      <div className="@5xl::ps-10 pt-2 text-center @2xl:ps-5 @2xl:text-left">
                        ...
                        <p className="text-sm leading-relaxed text-gray-900">
                          SVG، PNG، JPG یا GIF (حداکثر 800x400)
                        </p>
                      </div>
                    </>
                  }
