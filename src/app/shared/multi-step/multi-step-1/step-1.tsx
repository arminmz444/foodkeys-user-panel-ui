    ...
    <>
      <div className="col-span-full flex flex-col justify-center @4xl:col-span-5">
        <FormSummary
          ...
          title="در مورد مکانتون بهمون بگو"
          description="در این مرحله، از شما نوع ملکی که دارید و اینکه مهمان‌ها آیا کل مکان را اجاره می‌کنند یا فقط یک اتاق را، خواهیم پرسید."
        />
      </div>
