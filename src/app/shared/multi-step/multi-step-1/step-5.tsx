...
export const formSchema = z.object({
  ...
  guestType: z.string().min(1, 'این فیلد اجباری میباشد'),
  bedroomLock: z.string().min(1, 'این فیلد اجباری میباشد'),
});
  ...
  return (
    <>
      <div className="col-span-full flex flex-col justify-center @5xl:col-span-5">
        <FormSummary
          title="بیایید با مباحث ابتدایی شروع کنیم!"
          description="ترجیحات، نیازها و ویژگی‌های منحصر به فرد شما برای ما اهمیت دارد و ما بسیار هیجان‌زده هستیم تا یک تجربه‌ای را برای شما طراحی کنیم که ویژه شما باشد."
        />
      </div>
          ...
          <>
            ...
            <div className="grid gap-4">
              <Text className="font-semibold text-gray-900">
                آیا هر اتاق خواب باید قفل داشته باشد؟
              </Text>
              <Controller
                name="bedroomLock"
                control={control}
                render={({ field: { value, onChange } }) => {
                  ...
                  return (
                    ...
                    >
                      <Radio label="بله" value="yes" name="yes" />
                      <Radio label="خیر" value="no" name="no" />
                    </RadioGroup>
                  );
                }}
              />
