...
export const BasicInfoSchema = z.object({
  ...
  propertyName: z.string().min(1, { message: 'نام ملک الزامی میباشد' }),
  propertyType: z.string().min(1, { message: 'نوع ملک مورد الزامی میباشد' }),
  constructionStatus: z
    .string()
    .min(1, { message: 'وضعیت ساخت و ساز مورد الزامی میباشد' }),
