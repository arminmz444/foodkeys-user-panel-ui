...
export default function MaxHOAFilter({
  ...
  return (
    <SelectBox
      ...
      label="حداکثر هزینه انجمن مالکان"
      labelClassName="text-start text-sm 2xl:text-base font-semibold text-gray-900 mb-5 font-iransans font-iransans"
      placeholder="بدون کمترین"
