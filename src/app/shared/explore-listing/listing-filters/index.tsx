      ...
      <div className="relative flex flex-grow items-center gap-3">
        <div className="relative w-full xs:max-w-[298px]">
          <Autocomplete
            ...
            inputProps={{
              ...
              placeholder: 'شهر، محله، کد پستی، آدرس',
              inputClassName:
                'dark:[&_input::placeholder]:!text-gray-600 [&_input]:pe-3 [&_input]:ps-10 [&_input::placeholder]:px-2 px-5',
        ...
        <div className="hidden items-center gap-3 2xl:flex">
          <Popover
            ...
            shadow="sm"
            content={({ setOpen }) => (
              <PopoverContent title="برای فروش" setOpen={setOpen}>
                <ForSaleFilter
                  state={state}
