    ...
    >
      <div className="mt-3 flex items-start 2xl:mt-5">
        <div className="me-9 flex items-start">
          ...
          <div>
            <Text className="text-gray-500">دانلود ها</Text>
            <Text className="font-iransans text-sm font-semibold text-gray-900 dark:text-gray-700 2xl:text-base">
              15,556
            </Text>
          </div>
        </div>
        <div className="flex items-start">
          ...
          <div>
            <Text className="text-gray-500">آپلود ها</Text>
            <Text className="font-iransans text-sm font-semibold text-gray-900 dark:text-gray-700 2xl:text-base">
              10,065
            </Text>
          </div>
