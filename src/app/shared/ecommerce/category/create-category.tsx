...
const categoryFormSchema = z.object({
  name: z.string().min(1, { message: 'نام دسته بندی اجباری میباشد' }),
  slug: z.string().min(1, { message: 'عنوان منحصر به فرد الزامی میباشد' }),
          ...
          <div className="flex-grow pb-10">
            ...
            >
              <HorizontalFormBlockWrapper
                ...
                description={'اطلاهات دسته بندی جدید رو اینجا اضافه کن '}
              ...
              >
                ...
                />
                <Input
                  label="عنوان منحصر به فرد"
                  placeholder="عنوان منحصر به فرد"
                  {...register('slug')}
              ...
              <HorizontalFormBlockWrapper
                title="آپلود کردن عکس جدید"
                description="تصویر گالری محصول خود را اینجا بارگذاری کنید"
                isModalView={isModalView}
              >
                <Controller
                  control={control}
