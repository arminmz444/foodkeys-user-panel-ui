...
const data = [
  { name: 'فضای آزاد', value: 22 },
  { name: 'فضای استفاده شده', value: 78 },
];
          ...
          <PieChart className="[&_.recharts-layer:focus]:outline-none [&_.recharts-sector:focus]:outline-none dark:[&_.recharts-text.recharts-label]:first-of-type:fill-white">
            ...
            >
              <Label
                ...
                position="center"
                content={
                  <CustomLabel value1={data[1].value} value2={'از 100'} />
                }
              ></Label>
              {data.map((_, index) => (
                <Cell
        ...
        {data.map((item, index) => (
          ...
          >
            <div className="flex items-center justify-start">
              ...
              <Text
                tag="span"
                className="font-iransans text-sm font-medium text-gray-900 dark:text-gray-700"
              >
                {item.name}
              </Text>
            </div>
