...
export default function SalesReport({ className }: { className?: string }) {
  ...
  return (
    <WidgetCard
      ...
      description={
        <>
          <Badge renderAsDot className="me-0.5 bg-[#282ECA]" /> درآمد
          <Badge
            renderAsDot
          ...
          >
            ...
            >
              ...
              <YAxis
                ...
                tickLine={false}
                // tickMargin={10}
                tick={<CustomYAxisTick postfix={'تومان'} />}
              />
              <Tooltip
                content={
                  <CustomTooltip
                    className="[&_.chart-tooltip-item:last-child]:hidden"
                    persianTexts={{ revenue: 'درامد', expense: 'هزینه' }}
                  />
                }
              />
              <Bar
              ...
              <Bar
                  ...
                  fillOpacity={0.9}
                  shape={
                    <RoundedBottomBar className="fill-[#3AC3E9] dark:fill-[#3A88b2]" />
                  }
              />
              <Bar
                dataKey="expense"
                ...
                fillOpacity={0.9}
                shape={
                  <RoundedBottomBar className="fill-[#B8C3E9] dark:fill-[#7c88b2]" />
                }
              />
              <Area
                type="bump"
