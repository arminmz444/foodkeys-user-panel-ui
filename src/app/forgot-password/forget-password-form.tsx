...
const otpFormSchema = z.object({
    phoneNumber: z.string({required_error: "این فیلد الزامی است"}).nonempty({message: "نام کاربری الزامی است"}).regex(/^0[0-9]{10}$/, {message: "فرمت نام کاربری اشتباه است"}),
    // password: z
    //   .string()
...
export default function ForgetPasswordForm() {
    ...
    return (
        <>
            ...
            <Text
                className="mt-6 text-center text-[15px] leading-loose text-gray-500 lg:mt-8 lg:text-start xl:text-base">
