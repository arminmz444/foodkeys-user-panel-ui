    ...
    <div className="flex grow items-center px-6 xl:px-10">
      <div className="mx-auto flex w-full max-w-[1180px] flex-col-reverse items-center justify-between text-center lg:flex-row lg:gap-5 lg:text-start 3xl:max-w-[1520px]">
        <div>
          ...
          >
            خوش آمدید به داشبورد نهایی <br />
            ایزومورفیک.
          </Text>
          <p className="mb-6 max-w-[612px] text-sm leading-loose text-gray-500 md:mb-8 xl:mb-10 xl:text-base xl:leading-loose">
            ما ساعت‌های زیادی را صرف راه‌اندازی وب‌سایت جدیدمان کرده‌ایم. به ما
            بپیوندید. <br className="hidden sm:inline-block lg:hidden" /> برای
            دریافت آخرین به‌روزرسانی‌ها، از فهرست ایمیل ما استفاده کنید یا ما را
            در فیسبوک دنبال کنید.
          </p>
