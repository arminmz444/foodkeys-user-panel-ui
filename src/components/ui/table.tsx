...
const classes = {
  ...
  thead:
    '[&_thead]:text-left [&_thead]:rtl:text-right [&_th.rc-table-cell]:uppercase [&_th.rc-table-cell]:text-xs [&_th.rc-table-cell]:font-semibold [&_th.rc-table-cell]:text-white [&_th.rc-table-cell]:bg-black dark:[&_th.rc-table-cell]:text-black dark:[&_th.rc-table-cell]:bg-white',
  tCell:
...
export function ToggleColumns<T>({
  ...
  // console.log(columns.map((test: any) => ({ [test['dataIndex']]: '' })));
  return (
    <div className="">
      <Popover
        content={() => (
              ...
              {columns.map((column: any, index) => (
                <Checkbox
                  ...
                  label={
                    ...
                    addSpacesToCamelCase(column.dataIndex)
                  }
      ...
      >
        <ActionIcon variant="outline" title={'تغییر وضعیت ستون‌ها'}>
