            ...
            <DatePicker
                ...
                render={(value, openCalendar) => (
                    <div
                        ...
                        onFocus={(e) => {
                            e.currentTarget.style.borderColor = customInputFocusStyles.borderColor;
                            e.currentTarget.style.boxShadow = customInputFocusStyles.boxShadow;
                        }}
                        onBlur={(e) => {
                    ...
                    >
                        {/* The date text */}
                        <span>{value ? value : 'تاریخ ثبت'}</span>
                        {/* Calendar Icon */}
